...
UART_RX_CHAR_UUID = "6E400001-B5A3-F393-E0A9-E50E24DCCA9E"
...
async def uart_terminal():
    ...
    async with BleakClient(device, disconnect_callback=handle_disconnect) as client:#D711732A-3760-54E8-F046-6F6438C61AFC
